...
const CampViewAuthor = () => {
  return (
    <div className="py-[25px] gap-x-3 flex items-center">
      <img
        src={defaultImage}
      ...
      <div>
        <div className="flex items-center gap-x-4">
          <h3 className="text-text1 text-[18px] font-medium">Saiful Islam</h3>
        ...
        <div className="flex items-center gap-x-[10px]">
          ...
          <span className="text-sm text-text3 font-normal">
            Dhaka, Bangladesh
          </span>
        </div>
      </div>
